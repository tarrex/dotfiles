# Tarrex's .ycm_extra_conf.py file.
...
BASE_FLAGS = [
    ...
    '-ferror-limit=10000',
    '-DNDEBUG',
    '-std=c++11',   # For a C project, you would set this to something like 'c99' instead of 'c++11'.
    '-xc++',        # For a C project, you would set this to 'c' instead of 'c++'.
    '-I/usr/lib/',
    '-I/usr/include/'
]
