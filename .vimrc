...
augroup Go
    ...
    autocmd FileType go nmap <leader>go :GoRun<cr>
    ...
    autocmd FileType go nmap <leader>gi :GoImpl<space>
    autocmd FileType go nmap <leader>ga :GoAddTags<space>
    autocmd FileType go nmap <leader>gd :GoRemoveTags<space>
